...
class OnlineGameScene : MenuScene(1920,1040) {
    ...
    private val headlineLabel = Label(
        width = 570, height = 100, posX = 700, posY = 20, text = "Host Game",
        font = Font(size = 100, fontWeight = Font.FontWeight.BOLD)
    )
    val lobbyLabel = Label( width = 300, height = 100, posX = 2, posY = 2, text = "Session ID:",
        font = Font(size = 30, fontWeight = Font.FontWeight.BOLD))
    val sessionNrLabel = Label( width = 300, height = 100, posX = 2, posY = 50, text = "3847384783",
        font = Font(size = 30, fontWeight = Font.FontWeight.BOLD))
    ...
    private val player1EasyBox = CheckBox(posX = 870, posY = 900, text = "Easy Bot").apply {
        onCheckedChanged= {
            if(this.isChecked){
                localplayerMode = 2
                player1HardBox.isDisabled = true
    ...
    init {
        player1HardBox = CheckBox(posX = 1050, posY = 900, text = "Hard Bot").apply {
            onCheckedChanged= {
                if(this.isChecked){
                    localplayerMode = 3
                    player1EasyBox.isDisabled = true
        ...
        addComponents(
            headlineLabel,mainMenuButton, startGameButton, chooseGoal, lobbyLabel, sessionNrLabel,
